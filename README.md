CrystalDK is a Roblox UI Library which focuses on being highly functional whilst remaining unique.
...
Discord invite: https://discord.gg/fFycyK3NGe
Cloudflare load: local CrystalDK = loadstring(game:HttpGet("https://crystaldk.lososeunpicito.workers.dev/crystaldk?key=global"))()
All logic otherwise stays the same apart from new features
Beta 2.6.0 and below will not load, All versions above 2.6.0 have been hoasted on CloudFlare.
